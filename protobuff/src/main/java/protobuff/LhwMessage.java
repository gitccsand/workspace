...
public final class LhwMessage {
  ...
  public static final class LogonReqMessage extends
    ...
    public static protobuff.LhwMessage.LogonReqMessage parseFrom(
    ...
    public static protobuff.LhwMessage.LogonReqMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static protobuff.LhwMessage.LogonReqMessage parseFrom(
    ...
    public static protobuff.LhwMessage.LogonReqMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static protobuff.LhwMessage.LogonReqMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static protobuff.LhwMessage.LogonReqMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(protobuff.LhwMessage.LogonReqMessage prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          protobuff.LhwMessage.LogonReqMessage, Builder>
        implements protobuff.LhwMessage.LogonReqMessageOrBuilder {
      // Construct using protobuff.LhwMessage.LogonReqMessage.newBuilder()
      private Builder() {
      ...
      public protobuff.LhwMessage.LogonReqMessage getDefaultInstanceForType() {
        return protobuff.LhwMessage.LogonReqMessage.getDefaultInstance();
      }

      public protobuff.LhwMessage.LogonReqMessage build() {
        protobuff.LhwMessage.LogonReqMessage result = buildPartial();
      ...
      public protobuff.LhwMessage.LogonReqMessage buildPartial() {
        protobuff.LhwMessage.LogonReqMessage result = new protobuff.LhwMessage.LogonReqMessage(this);
      ...
      public Builder mergeFrom(protobuff.LhwMessage.LogonReqMessage other) {
        if (other == protobuff.LhwMessage.LogonReqMessage.getDefaultInstance()) return this;
        if (other.hasAcctID()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        protobuff.LhwMessage.LogonReqMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (protobuff.LhwMessage.LogonReqMessage) e.getUnfinishedMessage();
          throw e;
        } finally {
